  ...
  return (
    <div className="flex justify-center items-center space-x-1 mt-4">
      <button
        ...
        className={`p-2 disabled:opacity-50 flex justify-center ${
          currentPage === 1
      ...
      <div className="flex gap-1 overflow-x-auto">
        {pageNumbers.map((number, index) =>
          number === "..." ? (
            <span
              key={number + index}
              className="p-2 px-4 text-text-light rounded-md"
            >
              {number}
            </span>
          ) : (
            <button
              ...
              className={`p-2 px-4 ${
                currentPage === number ? " text-text-light " : "text-text-light"
              } rounded-md`}
            >
              {number}
            </button>
      ...
      <button
        ...
        className={`p-2 disabled:opacity-50 ${
          currentPage === totalPages
            ? "hover:border hover:border-blue-500"
            : "border border-blue-500"
        } hover:border hover:border-blue-500 flex justify-center items-center rounded-md`}
      >
